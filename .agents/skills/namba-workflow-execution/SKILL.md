...
Collaboration defaults: use a dedicated branch from `main` for the SPEC, open the PR into `main`, write the PR in English, and request `@codex review` on GitHub after the PR is open.
